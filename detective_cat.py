...
Original file is located at
    https://colab.research.google.com/drive/1CiBxlOoToKQrlviDYz5FEyOAKhnMw4OT
"""
...
def insertion_cost(char,word):
    ...
    if (word[len(word)-1] in S or word[len(word)-1]=='Š') and (char in S or char=="Š"):
      ...
      return 6
    if (word[len(word)-1] in WS or word[len(word)-1]=='Ш') and (char in WS or char=="Ш"):
      return 1.5
    elif (word[len(word)-1] in WS or word[len(word)-1]=='Ш') and (char not in WS or char !="Ш"):
      return 6
...
def deletion_cost(char,word):
    ...
    if (word[len(word)-2] in S or word[len(word)-2]=='Š') and (char in S or char=="Š"):
      ...
      return 6
    if (word[len(word)-2] in WS or word[len(word)-2]=='Ш') and (char in WS or char=="Ш"):
      return 1.5
    elif (word[len(word)-2] in WS or word[len(word)-2]=='Ш') and (char not in WS or char !="Ш"):
      return 6
...
def substitution_cost(char_a, char_b):
    if (char_a == "Ł" and char_b in LL) or (char_a in LL and char_b =="Ł"):
        ...
        return 7.5
    elif (char_a == "Ł" and char_b =="Ш") or (char_a =="Ш" and char_b =="Ł"):
        return 7
    ...
    if (char_a == "Ů" and char_b in UL) or (char_a in UL and char_b =="Ů"):
        ...
        return 7.5
    elif (char_a == "Ů" and char_b =="Ш") or (char_a =="Ш" and char_b =="Ů"):
        return 7
    ...
    if (char_a == "Đ" and char_b in DD) or (char_a in DD and char_b =="Đ"):
        ...
        return 6.5
    elif (char_a == "Đ" and char_b =="Ш") or (char_a =="Ш" and char_b =="Đ"):
        return 6
    ...
    if (char_a == "Š" and char_b in S) or (char_a in S and char_b =="Š"):
        ...
        return 6.5
    elif (char_a == "Š" and char_b =="Ш") or (char_a =="Ш" and char_b =="Š"):
        return 6

    if (char_a == "Ш" and char_b in WS) or (char_a in WS and char_b =="Ш"):
        return 0.5
    elif (char_a == "Ш" and char_b in LL) or (char_a in LL and char_b =="Ш"):
        return 7.5
    elif (char_a == "Ш" and char_b in UL) or (char_a in UL and char_b =="Ш"):
        return 7.5
    elif (char_a == "Ш" and char_b in DD) or (char_a in DD and char_b =="Ш"):
        return 6.5
    elif (char_a == "Ш" and char_b in S) or (char_a in S and char_b =="Ш"):
        return 6.5
